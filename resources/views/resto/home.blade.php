...
<div style="height: 750px;">
    ...
    <a href="/resto/profile" target="blank" style="text-decoration: none;">
    ...
    <a href="/resto/halamanrestoran" style="text-decoration: none;">
        <div class="col-md-12 mt-5 tombol1">
            <div class="row ">
                <div class="col-md-12 text-center">
    ...
    <a href="/resto/history" style="text-decoration: none;">
        <div class="col-md-12 mt-5 tombol1">
            <div class="row ">
                <div class="col-md-12 text-center">
    ...
    <a href="/resto/booking" style="text-decoration: none;">
        <div class="col-md-12 mt-5 tombol1">
            <div class="row ">
                <div class="col-md-12 text-center">
